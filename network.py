...
<a class='mymenu'  >Scan Network</a>

</div>

<div class='n'>
<a  class='mm'>Please provide your network range for scanning of Nodes</a>
</div>
...
<form action='ip22.py' method='post'>


<table class='center'>
<tr><td>Please Enter your Network:</td><td><input name="ip"></td></tr>
